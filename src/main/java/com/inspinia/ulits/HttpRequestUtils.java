...
import com.inspinia.ulits.wx.model.SSLClient;
...
//        String x = doPost2("http://localhost:8080/com.auditing/api/audit-histories/remarks", map, "UTF-8");
    	...
    	String token = WXTokenUtil.getAccessToken(BC_Constant.weixin_app_id, BC_Constant.weixin_app_secret_id).getToken();
    	String a = "https://api.weixin.qq.com/cgi-bin/material/batchget_material?access_token="+token;
    	Map para = new HashMap<String, String>();
    	para.put("type", "image");
    	para.put("offset", "0");
    	para.put("count", "5");
    	String rs = sendPost(a, JSON.toJSONString(para));
